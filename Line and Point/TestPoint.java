...
public class TestPoint {
    public static void main(String[] args) {
       ...
       p2.setXY(10, 11);
       System.out.printf("Distance is: %.2f%n", p1.distance(10, 11));  // print format
       System.out.printf("Distance is: %.2f%n", p1.distance(p2));
       System.out.printf("Distance is: %.2f%n", p2.distance(p1));
       System.out.printf("Distance is: %.2f%n", p1.distance());   // 2 decimal places in decimal representation of a floating-point number
    }
 }